...
export default function DonateIcon({ className, variant = "outline" }: DonateIconProps) {
  return variant === "filled" ? (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M9.375 3a1.875 1.875 0 000 3.75h1.875v4.5H3.375A1.875 1.875 0 011.5 9.375v-.75c0-1.036.84-1.875 1.875-1.875h3.193A3.375 3.375 0 0112 2.753a3.375 3.375 0 015.432 3.997h3.193c1.035 0 1.875.84 1.875 1.875v.75c0 1.036-.84 1.875-1.875 1.875H12.75v-4.5h1.875a1.875 1.875 0 10-1.875-1.875V6.75h-1.5V4.875A1.875 1.875 0 009.375 3zM12.75 12.75h7.5v7.125c0 1.035-.84 1.875-1.875 1.875H12.75v-9zm-1.5 0v9H5.625A1.875 1.875 0 013.75 19.875V12.75h7.5z" />
    </svg>
  ) : (
    <svg
      fill="none"
